                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input name="icon" readonly class="form-control icon" type="text"
                                                placeholder="Select Icon" aria-label="Recipient's username"
                                                spellcheck="false" data-ms-editor="true">
                                            <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                                data-bs-target="#exampleModalCenter">Select Icon</button>
                                        </div>
                                        <div class="svg-box d-none text-center"
                                            style="background-color: #d8e1ff; font-size: 50px;">
                                            <i class="preview-icon" style="font-size: 50px"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
